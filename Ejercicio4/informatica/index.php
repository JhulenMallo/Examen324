...
<!-- Cuerpo -->
        ...
        <header class="py-5 bg-image-full" style="background-image: url('../imagenes/info1280.jpg')">
            <div class="text-center my-5">
                <img class="img-fluid rounded-circle mb-4" src="../imagenes/info.jpg" alt="..." />
                <h1 class="text-white fs-3 fw-bolder">Carrera de Informática</h1>
