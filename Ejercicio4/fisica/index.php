...
<!-- Cuerpo -->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="#!">Física</a></li>
                    </ul>
                </div>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="nav-link disabled">Bienvenido <?php echo $_SESSION["idusuario"] ?></a></li>
                        <li class="nav-item"><a class="nav-link" href="../notas.php">Ver Notas</a></li>
        ...
        <header class="py-5 bg-image-full" style="background-image: url('../imagenes/fisica1280.jpg')">
            <div class="text-center my-5">
                <img class="img-fluid rounded-circle mb-4" src="../imagenes/fisica.jpg" alt="..." />
                <h1 class="text-white fs-3 fw-bolder">Carrera de Física</h1>
